...
#df = df[(df['Age Group'] == 2) & (df['Type'] == "Acquired")]
df = df[(df['Age Group'] == 1)]
...
plt.title("Optimal K Number for "+ hand + " Hand Analysis of Dystonia (Ages 15-21)" )
plt.show()
...
t = hand + ' Hand Analysis of Dystonia (Ages 15-21)' 

sns.scatterplot(df, x = hand_hi, y = hand_lo, style = "Predicted Group", hue = "Etiology",  size="Treatment", sizes=(50, 200)).set(title=t)
